...
`prefect deployment build etl_web_to_gcs.py:etl_web_to_gcs -n "etl1" --cron "0 5 1 * * " -a`
...
notes:  
`prefect deployment build etl_gcs_to_bq.py:parent_etl_flow -n "etl2" --cron "0 5 1 * * " -a`
new terminal:  
